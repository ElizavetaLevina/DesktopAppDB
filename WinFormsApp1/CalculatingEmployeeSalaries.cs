            ...
            /*for (int i = 0; i < listMasters.Count; i++)
            {
                for (int j = 0; j < list.Count; j++)
                {
                    if (list[j].ReturnUnderGuarantee) 
                    {
                        ...
                        if (monthCompleted == CheckMonth() && (monthCompleted != monthReturn || 
                            yearCompleted != yearReturn) && 
                            yearCompleted == Convert.ToInt32(comboBoxYears.Text) && !list[j].InProgress)
                        {
                            salary += list[j].PriceRepair;
                        }
                        else if (monthCompleted == CheckMonth() && monthCompleted == monthReturn &&
                            yearCompleted == yearReturn &&
                            yearCompleted == Convert.ToInt32(comboBoxYears.Text))
                        {
                            salary -= list[j].PriceRepair;
                        }
                    }
                    else
                    {
                        if (DateTime.Parse(list[i].DateCompleted).Month == CheckMonth() &&
                            DateTime.Parse(list[i].DateCompleted).Year == Convert.ToInt32(comboBoxYears.Text))
                        {
